...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 644.0, 160.5, 330.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"preset" : 1,
...
,
									"text" : "param @name length @min 0 @value 0 @max 14769.229025",
									"varname" : "length"
								}
...
,
									"text" : "param @name offset @min 0 @value 0 @max 10000",
									"varname" : "offset"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 930.0, 137.5, 44.0, 21.0 ],
									"text" : "Length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 13.0, 44.5, 249.0, 23.0 ],
...
,
									"text" : "buffer~ @name bufA @file 130_D_Pad_02_SP"
								}
...
, 							{
						...
						"export_config" : 						{
							"web-export" : 							{
								"json-web-export" : 								{
									"copy_dependencies" : 1,
									"file_name" : "patch.sampler-pad.json",
