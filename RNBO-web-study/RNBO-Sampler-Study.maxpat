...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 178.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 							{
								...
								"index" : 2,
								"tag" : "out2",
								"comment" : "envelope-follower-output"
							}
 ]
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"annotation" : "envelope-follower-output",
									"id" : "obj-27",
									"maxclass" : "newobj",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 170.0, 543.0, 36.0, 23.0 ],
									"rnbo_classname" : "out",
									"rnbo_extra_attributes" : 									{
										"comment" : "envelope-follower-output",
										"meta" : "envelope-follower-output"
									}
,
									"rnbo_serial" : 6,
									"rnbo_uniqueid" : "envelope-follower-output",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"index" : 											{
...
,
										"inputs" : [ 											{
												...
												"displayName" : "envelope-follower-output",
												"hot" : 1,
												"docked" : 0
											}
 ],
...
,
									"text" : "out 2",
									"varname" : "envelope-follower-output"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 218.5, 543.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 170.0, 507.0, 73.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 301.0, 479.0, 40.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 422.0, 380.0, 33.0, 23.0 ],
									"rnbo_classname" : "abs~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "abs~_obj-20",
									"text" : "abs~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 385.0, 355.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 359.0, 447.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 301.0, 507.0, 130.0, 52.0 ],
									"range" : [ 0.0, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 301.0, 418.0, 87.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 2,
									"rnbo_uniqueid" : "slide~_obj-14",
									"text" : "slide~ 900 900"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 473.0, 355.0, 29.5, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 644.0, 316.0, 104.0, 23.0 ],
									"rnbo_classname" : "trapezoid~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "trapezoid~_obj-5",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 730.0, 45.5, 32.0, 21.0 ],
									"text" : "Rate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 473.0, 44.5, 253.0, 23.0 ],
...
,
									"text" : "param @name rate @min -2 @value 1. @max 2",
									"varname" : "rate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 647.5, 103.5, 74.0, 23.0 ],
									"rnbo_classname" : "loadmess",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "loadmess_obj-52",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"input" : 											{
...
,
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 558.5, 131.5, 108.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 644.0, 190.5, 35.0, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 558.5, 75.5, 284.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"exponent" : 1.0,
										"tonormalized" : "",
...
,
									"text" : "param @name offset @min 0 @value 0 @max 24000",
									"varname" : "offset"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 840.0, 75.5, 42.0, 21.0 ],
									"text" : "Offset"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 932.0, 160.5, 44.0, 21.0 ],
									"text" : "Length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 489.0, 256.5, 56.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 644.0, 221.5, 35.0, 23.0 ],
									"rnbo_classname" : "+~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 473.0, 284.5, 190.0, 23.0 ],
...
,
									"text" : "groove~ bufA @loop 1 @end 2800"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 11.5, 56.0, 23.0 ],
									"rnbo_classname" : "loadbang",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 13.0, 178.5, 110.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : "<none>",
										"maximum" : "<none>",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 13.0, 148.5, 68.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 520.0, 389.0, 130.0, 52.0 ],
									"rnbo_classname" : "scope~",
									"rnbo_extra_attributes" : 									{
										"calccount" : 256.0,
										"bufsize" : 128.0
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 473.0, 418.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"outmode" : 0,
									"patching_rect" : [ 27.0, 76.5, 256.0, 63.0 ],
									"quiet" : 1,
									"rnbo_classname" : "waveform~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "waveform~_obj-2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 13.0, 44.5, 214.0, 23.0 ],
...
,
									"text" : "buffer~ @name bufA @file backbreaker"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 653.5, 348.0, 493.0, 348.0 ],
									"source" : [ "obj-5", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-33", 0 ],
									"midpoints" : [ 568.0, 215.0, 653.5, 215.0 ],
									"order" : 0,
									"source" : [ "obj-51", 0 ]
								}
...
, 							{
						...
						"export_config" : 						{
							"web-export" : 							{
								"json-web-export" : 								{
									"copy_dependencies" : 1,
									"file_name" : "patch.sampler-env-follower.json",
...
,
					"patching_rect" : [ 38.0, 135.0, 40.0, 22.0 ],
					"rnboattrcache" : 					{
						"offset" : 						{
							"label" : "offset",
							"isEnum" : 0,
...
,
					"saved_object_attributes" : 					{
						"optimization" : "O1",
						"parameter_enable" : 1,
						"uuid" : "0a28c377-cb33-11ed-8377-50ebf6ce3c3f"
					}
,
					"snapshot" : 					{
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"minorversion" : 0,
									"name" : "untitled",
									"origin" : "0a28c377-cb33-11ed-8377-50ebf6ce3c3f",
									"type" : "rnbo",
									"subtype" : "",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "untitled",
										"filename" : "untitled_20230325.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "9b2349553125ecd93c097cff26e04bdd"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 38.0, 91.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.0, 91.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 344.0, 91.0, 150.0, 22.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "Backbreaker.wav",
				"bootpath" : "~/Documents/Max 8/Library/audio",
				"patcherrelativepath" : "../../Max 8/Library/audio",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
